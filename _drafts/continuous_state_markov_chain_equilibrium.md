...
for {% katex %}\alpha\ <\ 1{% endkatex %}. In the plots following the the cumulative mean and standard deviation of computed from simulations are compared are compared with the equilibrium vales {% katex %}\mu_E{% endkatex %}
...
{% katex %}X_0{% endkatex %}, and {% katex %}\alpha{% endkatex %}.
